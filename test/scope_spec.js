...
describe('Scope', function() {
  ...
  describe('evalAsync', function() {
    ...
    it('executes $evalAsync\'ed the function later in the same cycle', function() {
      scope.aValue = [1, 2, 3];
  ...
  describe('destroy a watch', function() {
    var scope;
  ...
  describe('inheritance', function() {
    ...
    it('schedules a digest form root on $evalAsync', function(done) {
      var parent = new Scope();
      var child = parent.$new();
      var child2 = child.$new();
